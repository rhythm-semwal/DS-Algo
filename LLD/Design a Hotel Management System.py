...
entities:
    room
    guest - search new room and make booking, add room services and food items.
    System - whose booking , cancel booking, make booking, refund, send notifications, housekeeping log
    amenities
    payment
    reception
"""
